...
import { leadReviewSkillMatrix, leadDecisionSkillMatrix } from '../../services/leadService';
...
const LeadReview = () => {
  ...
  useEffect(() => {
    const fetchAssessment = async () => {
      const da = await leadReviewSkillMatrix();
  ...
  const handleSubmit = async () => {
    ...
    const result = await leadDecisionSkillMatrix(payload)
