...
export const SkillProgression = new EntitySchema({
    ...
    columns: {
      path_id: { primary: true, type: "int", generated: true },
      skill_id: { type: "int" },
      category_id: { type: "int" },
      from_level_id: { type: "int" },
      to_level_id: { type: "int" },
      guidance: { type: "text", nullable: true },
      resources_link: { type: "text", nullable: true }
    },
    relations: {
